set role hasiru;
create or replace view hasiru_registration_details
            ("Id", address_id, uuid, first_name, last_name, "Gender", date_of_birth, date_of_birth_verified,
             registration_date, facility_id, "Address title", is_voided, "Picture of the duly filled consent form",
             "Marital status","Photo of the person", "Religion", "Other religion", "Caste/Community", "Other Caste/Community",
             ...
             "Permanent Address Contact Number 2", "Do you have a local address proof?", "Type of local address proof",
             "Name of the ID", "Local ID description", "How long have you been a informal waste/sanitation worker?",
             ...
             "Occupational Identity Card No.", "Upload Photo of the ID", "Whether you have Voter Registration Card",
             "Photo of Voter Id",
             "Whether you have Ration/BPL Card with your name included", "Photo of Ration/BPL Card",
             "Whether you have Aadhar Card", "Photo of Aadhar Card", "Whether you have Aadhar Enrolment ID",
             "Photo of Aadhar Enrolment ID", "Whether you have Labour Card",
             "Whether you have Health Card", "Whether you have PAN Card", "Photo of PAN Card",
             "Whether you have Driving license", "Photo of  Driving license", "Whether you have Cast Certificate",
             "Photo of  Cast Certificate", "Do you have Income Certificate","Photo of Income Certificate","Whether you have any Other Cards",
             "Photo of ID Card","Name of the ID Card", "Description of ID", "What is the type of ownership of your house?",
             ...
             "Do you have a doctor's certificate indicating the percentage of","Doctor's certificate", "Do you experience any of these?",
...
SELECT individual.id                                                                             AS "Id",
       ...
       (individual.observations ->>
        '8756c196-0333-4eda-aed5-8a3c69ed6dbb'::text)                                            AS "Photo of the person",
       (single_select_coded((individual.observations ->>
       ...
       single_select_coded(individual.observations ->>
                           '26d8ce68-d7cd-4a2b-b5aa-9dddbf9e8bcd'::text)                         AS "Do you have a local address proof?",
       multi_select_coded(individual.observations ->
                          '851d417e-1925-4604-9fce-0a7eb0d40128'::text)                          AS "Type of local address proof",
       (individual.observations ->>
        '2332141c-4453-4d6d-bcc1-bc3fde90f2d3'::text)                                            AS "Name of the ID",
       (individual.observations ->>
        'a3d60cb8-8615-44fc-a3b0-4bb32d0933f3'::text)                                            AS "Local ID description",
       (single_select_coded((individual.observations ->>
       ...
       (individual.observations ->>
        '8311695f-16ad-4597-9335-774d467e2559'::text)                                            AS "Occupational Identity Card No.",
       (individual.observations ->>
        '8756d237-c80a-4a26-b02a-45b665ea2a91'::text)                                            AS "Upload Photo of the ID",

       single_select_coded(individual.observations ->>
                           '23dbec91-3aae-4e0f-98ee-17f75efb64d0'::text)                         AS "Whether you have Voter Registration Card",
       (individual.observations ->>
        '429b4f74-be8f-4c63-b8d7-8ff574adfe6b'::text)                                            AS "Photo of Voter Id",

       (single_select_coded((individual.observations ->>
                             '28d66d45-5d71-4648-acc7-9a18716b98e0'::text)))::text               AS "Whether you have Ration/BPL Card with your name included",
       (individual.observations ->>
        '80e58886-33fe-4aea-81e0-18a9b196cdcc'::text)                                            AS "Photo of Ration/BPL Card",
       (single_select_coded((individual.observations ->>
                             'c1f2b0cb-8bd0-4b6c-ab00-1ab710817a09'::text)))::text               AS "Whether you have Aadhar Card",
       (individual.observations ->>
        'be129af3-8938-4cf8-ab07-020524f9fc1e'::text)                                            AS "Photo of Aadhar Card",
       (single_select_coded((individual.observations ->>
                             '17147552-019f-43d2-bfb3-300742d8daf8'::text)))::text               AS "Whether you have Aadhar Enrolment ID",
       (individual.observations ->>
        '331b1d4a-ec7e-40bd-84c3-462c323c0620'::text)                                            AS "Photo of Aadhar Enrolment ID",
       (single_select_coded((individual.observations ->>
       ...
       (individual.observations ->>
        '4f7f1fce-142a-432c-bd4a-e72e6b3bbfd9'::text)                                            AS "Photo of PAN Card",

       (single_select_coded((individual.observations ->>
                             '0e2fa18f-9840-4187-bb90-3c7ef92c05d9'::text)))::text               AS "Whether you have Driving license",
       (individual.observations ->>
        '178b675a-6373-4f01-8035-8c0aa2e66bcd'::text)                                            AS "Photo of  Driving license",
       (single_select_coded((individual.observations ->>
                             'ea39faca-9b32-4437-a080-719c7a0f0498'::text)))::text               AS "Whether you have Cast Certificate",
       (individual.observations ->>
        'e12f5b16-088c-4406-996b-ecb3a09126b0'::text)                                            AS "Photo of  Cast Certificate",

       (single_select_coded((individual.observations ->>
                             '685b9b91-deb3-475f-b1ed-e18fed8f1560'::text)))::text               AS "Do you have Income Certificate",
       (individual.observations ->>
        '5296ba3a-d710-4a6a-9289-01a36203457e'::text)                                            AS "Photo of Income Certificate",

       (single_select_coded((individual.observations ->>
                             '3d7cb170-d363-4c90-8755-43aec444abfd'::text)))::text               AS "Whether you have any Other Cards",
       (individual.observations ->>
        '4f60af9f-fe12-43c3-b1da-d72ddc481752'::text)                                            AS "Photo of ID Card",
       (individual.observations ->>
        '74e32026-d054-4843-9dd3-dfe8a065b013'::text)                                            AS "Name of the ID Card",
       (individual.observations ->>
       ...
       (individual.observations ->>
        '744117e0-fd3e-4f92-a776-57750774772e'::text)                                            AS "Doctor's certificate",
